...
export class CitrixShareFileTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Citrix Share File Trigger',
		name: 'citrixShareFileTrigger',
		group: ['trigger'],
		version: 1,
		description: 'Trigger events',
		defaults: {
			name: 'Citrix Share File Trigger',
			color: '#00FF00',
		},
		inputs: [],
		outputs: ['main'],
