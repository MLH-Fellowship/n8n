...
export async function getAccessToken(this: IExecuteFunctions | IExecuteSingleFunctions | ILoadOptionsFunctions | IHookFunctions): Promise<any> { // tslint:disable-line:no-any
	...
	const options: OptionsWithUrl = {
		...
		auth: {
			...
			pass: credentials?.consumerSecret as string,
		},
		form: {
...
export async function genericRequest(this: IExecuteFunctions | IExecuteSingleFunctions | ILoadOptionsFunctions | IHookFunctions, method: string, resource: string, body: any = {}, qs: IDataObject = {}, uri?: string, option: IDataObject = {}): Promise<any> { // tslint:disable-line:no-any
	let options: OptionsWithUrl = {
		method,
		body,
		qs,
